...
При установке выберите дополнительные языки (например, русский), если они нужны.

После установки добавьте Tesseract в переменную PATH. По умолчанию он устанавливается в:

```
C:\Program Files\Tesseract-OCR
```

Добавьте этот путь в системную переменную `PATH` через:
